...
#define ADC12ICH4MAP        (0x1000u)    /* ADC12 Internal Channel 4 select */
...
#define ADC12ICH4MAP_H      (0x0010u)    /* ADC12 Internal Channel 4 select */
...
#define OFS_CDCTL0            (0x0000u)  /* Comparator D Control Register 0 */
#define OFS_CDCTL0_L           OFS_CDCTL0
#define OFS_CDCTL0_H           OFS_CDCTL0+1
#define OFS_CDCTL1            (0x0002u)  /* Comparator D Control Register 1 */
#define OFS_CDCTL1_L           OFS_CDCTL1
#define OFS_CDCTL1_H           OFS_CDCTL1+1
#define OFS_CDCTL2            (0x0004u)  /* Comparator D Control Register 2 */
#define OFS_CDCTL2_L           OFS_CDCTL2
#define OFS_CDCTL2_H           OFS_CDCTL2+1
#define OFS_CDCTL3            (0x0006u)  /* Comparator D Control Register 3 */
#define OFS_CDCTL3_L           OFS_CDCTL3
#define OFS_CDCTL3_H           OFS_CDCTL3+1
#define OFS_CDINT             (0x000Cu)  /* Comparator D Interrupt Register */
#define OFS_CDINT_L            OFS_CDINT
#define OFS_CDINT_H            OFS_CDINT+1
#define OFS_CDIV              (0x000Eu)  /* Comparator D Interrupt Vector Word */
...
#define OFS_MPUSEG            (0x0004u)  /* MPU Segmentation Register */
#define OFS_MPUSEG_L           OFS_MPUSEG
#define OFS_MPUSEG_H           OFS_MPUSEG+1
#define OFS_MPUSAM_FR57xx      (0x0006u)  /* MPU Access Management Register */
...
#define OFS_MPUCTL1_L          OFS_MPUCTL1
#define OFS_MPUCTL1_H          OFS_MPUCTL1+1
#define OFS_MPUSEGB2          (0x0004u)  /* MPU Segmentation Boarder 2 Register */
#define OFS_MPUSEGB2_L         OFS_MPUSEGB2
#define OFS_MPUSEGB2_H         OFS_MPUSEGB2+1
#define OFS_MPUSEGB1          (0x0006u)  /* MPU Segmentation Boarder 1 Register */
...
#define OFS_MPUIPSEGB2        (0x000Cu)  /* MPU IP Segment Boarder 2 Register */
#define OFS_MPUIPSEGB2_L       OFS_MPUIPSEGB2
#define OFS_MPUIPSEGB2_H       OFS_MPUIPSEGB2+1
#define OFS_MPUIPSEGB1        (0x000Eu)  /* MPU IP Segment Boarder 1 Register */
...
#define OFS_PASELC            (0x0010u)  /* Port A Complement Selection */
...
#define OFS_PBSELC            (0x0010u)  /* Port B Complement Selection */
...
#define OFS_PCSELC            (0x0010u)  /* Port C Complement Selection */
...
#define OFS_PDSELC            (0x0010u)  /* Port D Complement Selection */
...
#define OFS_PESELC            (0x0010u)  /* Port E Complement Selection */
...
#define OFS_PFSELC            (0x0010u)  /* Port F Complement Selection */
...
#define OFS_PJSELC            (0x0010u)  /* Port J Complement Selection */
...
#define OFS_RF1ADINB           (0x0010)       /* Radio instruction word register */
...
#define OFS_RF1AINSTRB         (0x0011)       /* Radio instruction byte register */
...
#define OFS_RF1AINSTR1B        (0x0013)       /* Radio instruction byte register with 1-byte auto-read */
...
#define OFS_RF1ADOUTB          (0x0020)       /* Radio byte data out register without auto-read */
#define OFS_RF1ADOUT0B         (0x0020)       /* Radio byte data out register without auto-read */
...
#define OFS_RF1ASTATB          (0x0021)       /* Radio status byte register without auto-read */
#define OFS_RF1ADOUT1B         (0x0022)       /* Radio byte data out register with 1-byte auto-read */
